# 国智投洞见 · OpenClaw Skill

> 两层检索 + OpenClaw 主控 AI 分析 · 飞书文档输出 · 引用透明 · 零外部 LLM 依赖

参照「国智投洞见」品牌风格，自动从指定微信公众号抓取近期文章，由 OpenClaw Agent 直接分类、撰写先导洞见，每条资讯标注来源，文档末尾附完整引用清单，结果落飞书文档。
